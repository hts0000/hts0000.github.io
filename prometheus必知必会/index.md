...
`Prometheus`架构图：  
![](https://raw.githubusercontent.com/hts0000/images/main/202306051122342.png)
...
![](https://raw.githubusercontent.com/hts0000/images/main/202306061828781.png)
...
![](https://raw.githubusercontent.com/hts0000/images/main/202306061843980.png)
...
![](https://raw.githubusercontent.com/hts0000/images/main/202306071006349.png)
...
![](https://raw.githubusercontent.com/hts0000/images/main/202306071042115.png)
...
```
![](https://raw.githubusercontent.com/hts0000/images/main/202306071049873.png)

把区间向量打印出来，手动计算一下是否与`rate()`公式计算的结果一致。  
![](https://raw.githubusercontent.com/hts0000/images/main/202306071057786.png)
...
![](https://raw.githubusercontent.com/hts0000/images/main/202306071106855.png)

其实也可以手动获取这一连串的结果，通过`offset`来指定获取之前时间的值，如下所示，取满30分钟或者说1800秒，如果说采样间隔是`15s`的话，那么`30m`内最多可以计算出120个顺势向量，将这120个瞬时向量连起来，就得到`Prometheus Graph`展示的图形了。当然了，实际`Prometheus`并不会这样做，而是通过其他更加高效的方法来得到`Prometheus Graph`展示的图形。
```promql
...
```
![](https://raw.githubusercontent.com/hts0000/images/main/202306071122640.png)
...
![](https://raw.githubusercontent.com/hts0000/images/main/202306071135771.png)

## increase()
`increase()`使用方法和呈现图像都与`rate()`相似，区别在于Y轴数据是数值而非百分比。  
![](https://raw.githubusercontent.com/hts0000/images/main/202306071159191.png)
...
下图查询go语言堆上对象的数量。
![](https://raw.githubusercontent.com/hts0000/images/main/202306071408370.png)
...
![](https://raw.githubusercontent.com/hts0000/images/main/202306051158225.png)

在众多`metrics`中有一个名为`promhttp_metric_handler_requests_total`的`metric`，记录了`prometheus`的`/metrics`接口各个状态的访问次数。  
![](https://raw.githubusercontent.com/hts0000/images/main/202306051207777.png)

也可以访问`http://localhost:9090/graph`，通过可视化的方式展示这个时序数据。  
![](https://raw.githubusercontent.com/hts0000/images/main/202306051343402.png)
...
![](https://raw.githubusercontent.com/hts0000/images/main/202306051349672.png)
...
![](https://raw.githubusercontent.com/hts0000/images/main/202306051612474.png)
...
![](https://raw.githubusercontent.com/hts0000/images/main/202306061039863.png)

点击`Data sources`来进入添加数据源界面。  
![](https://raw.githubusercontent.com/hts0000/images/main/202306061043379.png)

选择`Prometheus`添加数据源，配置其地址和端口，在底部选择`Save & test`保存。  
![](https://raw.githubusercontent.com/hts0000/images/main/202306061046058.png)
...
![](https://raw.githubusercontent.com/hts0000/images/main/202306061051924.png)

选择监控看板的数据源，监控看板展示通过`PromQL`查询出的`metric`数据。下面配置将以`Time series`的方式展示`promhttp_metric_handler_requests_total`指标的数据。  
![](https://raw.githubusercontent.com/hts0000/images/main/202306061058645.png)

在这个`DashBoard`页面就能看到刚刚配置的时间序列看板。  
![](https://raw.githubusercontent.com/hts0000/images/main/202306061104031.png)

![](https://raw.githubusercontent.com/hts0000/images/main/202306061129445.png)

## 导入导出DashBoard
如果监控指标很多，需要配置很多看板，如果有多套`Grafana`还需重复配置，很麻烦。好消息是我们可以导出配置，并在其他`Grafana`中导入配置。  
![](https://raw.githubusercontent.com/hts0000/images/main/202306061118596.png)
...
![](https://raw.githubusercontent.com/hts0000/images/main/202306061415977.png)

![](https://raw.githubusercontent.com/hts0000/images/main/202306061416344.png)

![](https://raw.githubusercontent.com/hts0000/images/main/202306061425987.png)
...
![](https://raw.githubusercontent.com/hts0000/images/main/202306081501256.png)

当持续`10s`后，告警信息状态变为`FIRING`，`Altermanager`收到告警信息，并发送告警信息到指定邮箱。  
![](https://raw.githubusercontent.com/hts0000/images/main/202306081503443.png)

![](https://raw.githubusercontent.com/hts0000/images/main/202306081504082.png)
