...
![hugo安装成功](https://cdn.jsdelivr.net/gh/hts0000/hts0000.github.io/images/00.PNG "hugo安装成功")
...
![下载LoveIt主题](https://cdn.jsdelivr.net/gh/hts0000/hts0000.github.io/images/01.PNG "下载LoveIt主题")
![下载LoveIt主题](https://cdn.jsdelivr.net/gh/hts0000/hts0000.github.io/images/02.png "下载LoveIt主题")
...
![下载LoveIt主题](https://cdn.jsdelivr.net/gh/hts0000/hts0000.github.io/images/03.png "下载LoveIt主题")
...
![Favicon Generator生成图标](https://cdn.jsdelivr.net/gh/hts0000/hts0000.github.io/images/06.PNG  "Favicon Generator生成图标")

上传之后成功之后来到页面最下方点击`Generate your Favicons and HTML code`，Favicon Generator会自动分辨率生成符合一系列PC和移动终端的图标。
![Favicon Generator生成图标](https://cdn.jsdelivr.net/gh/hts0000/hts0000.github.io/images/07.PNG "Favicon Generator生成图标")

点击`Favicon package`下载生成好的图标包。
![Favicon Generator下载图标](https://cdn.jsdelivr.net/gh/hts0000/hts0000.github.io/images/08.PNG "Favicon Generator下载图标")

将下载好的图标包解压，把里面的文件全部复制到`D:\MyBlog\static\`目录下。
如果想要替换主页的头像图标，需要替换`D:\MyBlog\static\images\avatar.png`，推荐分辨率为528*560。

最后整体效果如下图所示。
![博客展示](https://cdn.jsdelivr.net/gh/hts0000/hts0000.github.io/images/09.PNG "博客展示")
...
![模板文件](https://cdn.jsdelivr.net/gh/hts0000/hts0000.github.io/images/10.PNG "模板文件")
...
![GitHub仓库](https://cdn.jsdelivr.net/gh/hts0000/hts0000.github.io/images/11.PNG "GitHub仓库")
...
```
在GitHub上查看提交。
![GitHub仓库](https://cdn.jsdelivr.net/gh/hts0000/hts0000.github.io/images/12.PNG "GitHub仓库")

最后在浏览器上访问URL:`<仓库名称>.github.io`即可通过网络访问到静态页面。
![GitHub仓库](https://cdn.jsdelivr.net/gh/hts0000/hts0000.github.io/images/13.PNG "GitHub仓库")
